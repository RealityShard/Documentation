...
public interface RequestDispatcher {
     ...
     * @throws      ShardletException       If there was any shardlet-internal exception
     * @throws      IOException             The usual crap.
     */
    public void forward(ShardletRequest request, ShardletResponse response)
    		throws ShardletException, IOException;
     ...
     * @throws      IOException             The usual crap.
     */
    public void include(ShardletRequest request, ShardletResponse response)
    		throws ShardletException, IOException;
}