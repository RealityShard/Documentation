...
public interface Shardlet 
{
   ...
   public String getShardletInfo();
    ...
    /**
     * Called by the container if there was a request from a client
     * 
     * @param		req						The request object (generated by your container)
     * @param		res						The response object (generated by the container,
     * 										but filled with your stuff)
     * @exception	ShardletException		May be thrown if anything didn't work right during
     * 										request-handling or response-creation.
     * 										Hint: A response may be created by another object
     * 										than this shardlet.
     * @exception	IOException				If any I/O Exception occured.
     */
    public void service(ShardletRequest req, ShardletResponse res)
