...
/**
 * <p>Java class for Shardlets complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Shardlets">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Shardlet" type="{}Shardlet" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Shardlets", propOrder = {
    "shardlet"
})
public class Shardlets {

    @XmlElement(name = "Shardlet", required = true)
    protected List<Shardlet> shardlet;
     ...
     * 
     */
    public List<Shardlet> getShardlet() {
        if (shardlet == null) {
            shardlet = new ArrayList<Shardlet>();
        }
